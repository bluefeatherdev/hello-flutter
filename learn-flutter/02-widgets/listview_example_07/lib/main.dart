// Learn Flutter - Widgets - ListView Example 07:
import 'package:flutter/material.dart';

// [ListTile] selection in a [ListView] or [GridView]
...
class ListTileSelectExample extends StatefulWidget {
  ...
  @override
  State<ListTileSelectExample> createState() => _ListTileSelectExampleState();
}

class _ListTileSelectExampleState extends State<ListTileSelectExample> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('ListViewApp Example 07'),
