// Learn Flutter - Widgets - ListTile Example 10
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          const Padding(padding: EdgeInsetsGeometry.symmetric(vertical: 2.0)),
          Text(user, style: const TextStyle(fontSize: 10.0)),
          const Padding(padding: EdgeInsetsGeometry.symmetric(vertical: 1.0)),
...
class CustomListItemExample extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('ListTile Sample 10 (Custom)')),
      body: ListView(
