// Learn Flutter - Widgets - FloatingActionButton Example 01:
...
class _FloatingActionButtonExampleState
  ...
  int index = 0; // Selects the customizations.

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('FloatingActionButton Sample 01')),
