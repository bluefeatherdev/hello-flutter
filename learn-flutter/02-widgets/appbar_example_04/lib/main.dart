// Learn Flutter - Widgets - AppBar Example 04:
...
class AppBarExample extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color oddItemColor = colorScheme.primary.withAlpha(
      13,
    ); // 0.05 * 255 ≈ 13
    final Color evenItemColor = colorScheme.primary.withAlpha(
      38,
    ); // 0.15 * 255 ≈ 38
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          //
          // When `ThemeData.useMaterial3` is true and scroll viw has
