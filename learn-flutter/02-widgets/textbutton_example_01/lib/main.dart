// Learn Flutter - Widgets - TextButton Example 01
import 'package:flutter/material.dart';

void main() => runApp(const TextButtonApp());
...
class _TextButtonAppState extends State<TextButtonApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(title: const Text('TextButton Sample 01')),
        body: Padding(
...
class _TextButtonExampleState extends State<TextButtonExample> {
  ...
  Widget build(BuildContext context) {
    ...
    // Always return a gradient decoration so that AnimationContainer
    // can interpole in between. Used by TextButton #7.
    ...
    final List<Widget> columnOneButtons = <Widget>[
      ...
      // ButtonStyle WidgetStateProperty parameter for you.
    ...
    return Row(
      children: <Widget>[
        ...
        // in the appropriate dark/light ThemeMode. The directionality of the rest
