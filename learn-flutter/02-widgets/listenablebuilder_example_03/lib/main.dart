// Learn Flutter - Widgets - ListenableBuilder Example 03:
import 'package:flutter/material.dart';

void main() => runApp(const ListenableBuilderExample());

/// This widget listen for changes in the focus state of subtree define by
...
class _ListenableBuilderExampleState extends State<ListenableBuilderExample> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'ListenableBuilder Sample 03',
      home: Scaffold(
        appBar: AppBar(title: const Text('ListenableBuilder Sample 03')),
        body: Center(
          child: SizedBox(
            width: 300,
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  FocusListenerContainer(
                    ...
                    // The border side will be wider when the subtree has focus.
